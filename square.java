...
public class square extends quadrilateral implements Comparable<square>{
	public square(double AB, double BC, double CD, double DA, double AC, double DB, double a, double b, double c,
...
//			return Arbitrary1[0];
//}
 static ArrayList square  = new ArrayList();
